...
$(function (selector) {
    ...
    $(selector).on("click", 'tr th span', function () {
        ...
        EmployeeAjax("/trainingHistories/search",
            {
                search: $('#search').val(),
                items: $('#items').val(),
    ...
    $('#DeleteModal').on('show.bs.modal', function (e) {
        $.ajax({
            url: "/trainingHistories/CourseDetail/" + elemId,
            cache: false,
    ...
    $('#confDelete').on('click', function () {
        $.ajax({
            url: "/trainingHistories/delete/" + elemId,
            cache: false,
            type: 'post',
            success: function (data) {
                $("#DeleteModal").modal('hide');
                location.reload(); // todo reload partial view using ajax
            }
        });
    });
