...
{
    public class TrainingHistoryHomeViewModel
    {
        public TrainingHistory[] trainingHistories { get; set; }
        ...
        public TrainingHistoryHomeViewModel(string sortBy, string order)
        {
            this.order = order;
            this.sortBy = sortBy;
